...
import abused_master.avaritiaadditions.items.tools.ToolHelper;
...
public class ItemMatterCluster extends Item {
    ...
    public ItemMatterCluster() {
        ...
        GameRegistry.register(this.setRegistryName("mattercluster"));
        //this.setTextureName("mattercluster");
    }
    /*
