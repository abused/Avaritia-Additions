...
public class Collector extends BlockContainer {
    ...
    public Collector() {
        ...
        this.setUnlocalizedName("collector");
        this.setRegistryName("collector");
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
        if(!worldIn.isRemote) {
            playerIn.openGui(AvaritiaAdditions.instance, GuiHandler.GUI_COLLECTOR, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }
