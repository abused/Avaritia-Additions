...
public class NeutroniumCompressor extends BlockContainer {
    ...
    public NeutroniumCompressor() {
        ...
        this.setUnlocalizedName("neutronium_compressor");
        GameRegistry.register(this.setRegistryName("neutronium_compressor"));
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
        if(!worldIn.isRemote) {
            playerIn.openGui(AvaritiaAdditions.instance, GuiHandler.GUI_COMPRESSOR, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }
